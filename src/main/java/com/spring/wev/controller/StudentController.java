...
//    Student addStudent(@PathVariable("idStudent") Long id){
    ...
    ResponseEntity<StudentDto> getStudent(@RequestParam("studentId") Long id){
//        return ResponseEntity.ok(studentService.getStudentById(id));
    ...
    List<StudentDto> getAllStudentByName(@RequestParam String name){
        return studentService.getStudentByName(name);
    }

    @GetMapping("/allStudentByNameContains")
    List<StudentDto> getAllStudentByNameContains(@RequestParam String letters){
        return studentService. getStudentLikeLetter(letters);
    }

    @GetMapping("/allStudentByAge")
    List<StudentDto> getAllStudentByAge(@RequestParam int age){
